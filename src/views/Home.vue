        ...
        .row.g-0
          ...
          .col-xl-6.info-section
            .content-wrapper.px-lg-4.pt-lg-4.px-xxl-5.py-xxl-5.text-start
              ...
              p.descripcion.mb-4 El cálculo es esencial en la administración de empresas, permitiendo modelar fenómenos económicos y financieros. Esta unidad abarca desigualdades, inecuaciones, valor absoluto y funciones, con aplicaciones en costos, ingresos y demanda. Se presentan ejemplos y ejercicios para reforzar el aprendizaje. Se analizan restricciones y regiones factibles para optimización. También se estudian funciones y sus operaciones, junto con su representación gráfica y análisis económico. Se incluyen referencias y materiales complementarios para facilitar la comprensión.
